...
urlpatterns = [
   ...
   path('api/get-tour/<int:tour_id>', views.api_get_tour, name="get a tour by id"),
   path('api/get-tour-locations/', views.api_all_tour_locations, name="get all values in the look up table"),
